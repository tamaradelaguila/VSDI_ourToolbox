...
...MATLAB FUNCTION MODIFIED TO CALL A MODIFIED 'meansgraph' vVERSION, ALLOWING THE GRAPH TO BE SUBPLOTTED
...
if (dodisp)
   ...
   halfwidth = crit * w(:);
   hh = meansgraph_modif(gmeans, gmeans-halfwidth, gmeans+halfwidth, ...
                   gnames, mname);
