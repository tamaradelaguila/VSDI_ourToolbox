function [] = plot_tilemovie12frames(moviedata, times, tileset)
...
%    imagesc(imtiles(:,:,ploti))
   plot_framesoverlaid(imtiles(:,:,i),background, imalpha(:,:,i) ,0, ax1, tileset.clims, 0); 
   ...
   plot_framesoverlaid(imtiles(:,:,i),background, imalpha(:,:,i) ,0, ax2, tileset.clims, 0); 
   tit= strcat(num2str(datatime(timeindx(i))), 'ms');
   title(tit, 'fontsize', 6)
   set(gca,'XColor', 'none','YColor','none')
   ...
   plot_framesoverlaid(imtiles(:,:,i),background, imalpha(:,:,i) ,0, ax3, tileset.clims, 0); 
   tit= strcat(num2str(datatime(timeindx(i))), 'ms');
   title(tit, 'fontsize', 6)
   set(gca,'XColor', 'none','YColor','none')
   ...
   plot_framesoverlaid(imtiles(:,:,i),background, imalpha(:,:,i) ,0, ax4, tileset.clims, 0); 
   tit= strcat(num2str(datatime(timeindx(i))), 'ms');
   title(tit, 'fontsize', 6)
   set(gca,'XColor', 'none','YColor','none')
   ...
   plot_framesoverlaid(imtiles(:,:,i),background, imalpha(:,:,i) ,0, ax5, tileset.clims, 0); 
   tit= strcat(num2str(datatime(timeindx(i))), 'ms');
   title(tit, 'fontsize', 6)
   set(gca,'XColor', 'none','YColor','none')
   ...
   plot_framesoverlaid(imtiles(:,:,i),background, imalpha(:,:,i) ,0, ax6, tileset.clims, 0); 
   tit= strcat(num2str(datatime(timeindx(i))), 'ms');
   title(tit, 'fontsize', 6)
   set(gca,'XColor', 'none','YColor','none')
   ...
   plot_framesoverlaid(imtiles(:,:,i),background, imalpha(:,:,i) ,0, ax7, tileset.clims, 0); 
   tit= strcat(num2str(datatime(timeindx(i))), 'ms');
   title(tit, 'fontsize', 6)
   set(gca,'XColor', 'none','YColor','none')
   ...
   plot_framesoverlaid(imtiles(:,:,i),background, imalpha(:,:,i) ,0, ax8, tileset.clims, 0); 
   tit= strcat(num2str(datatime(timeindx(i))), 'ms');
   title(tit, 'fontsize', 6)
   set(gca,'XColor', 'none','YColor','none')
   ...
   plot_framesoverlaid(imtiles(:,:,i),background, imalpha(:,:,i) ,0, ax9, tileset.clims, 0); 
   tit= strcat(num2str(datatime(timeindx(i))), 'ms');
   title(tit, 'fontsize', 6)
   set(gca,'XColor', 'none','YColor','none')
   ...
   plot_framesoverlaid(imtiles(:,:,i),background, imalpha(:,:,i) ,0, ax10, tileset.clims, 0); 
   tit= strcat(num2str(datatime(timeindx(i))), 'ms');
   title(tit, 'fontsize', 6)
   set(gca,'XColor', 'none','YColor','none')
   ...
   ax11 = subplot(nrows, ncols, i);
      tit= strcat(num2str(datatime(timeindx(i))), 'ms');
   plot_framesoverlaid(imtiles(:,:,i),background, imalpha(:,:,i) ,0, ax11, tileset.clims, 0, tit); 
   title(tit, 'fontsize', 6)
   set(gca,'XColor', 'none','YColor','none')
   ...
   plot_framesoverlaid(imtiles(:,:,i),background, imalpha(:,:,i) ,0, ax12, tileset.clims, 1); 
   tit= strcat(num2str(datatime(timeindx(i))), 'ms');
   title(tit, 'fontsize', 6)
   set(gca,'XColor', 'none','YColor','none')
...
function  plot_framesoverlaid(imAct, imBack, logicalpha, plotnow, axH, act_clim, plot_cbar, tit)
% INPUT 
